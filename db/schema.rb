...
ActiveRecord::Schema.define(:version => 20150819061509) do
  ...
  add_index "recipe_ingredients", ["ingredient_id", "recipe_id"], :name => "index_recipe_id_ingredient_id", :unique => true
