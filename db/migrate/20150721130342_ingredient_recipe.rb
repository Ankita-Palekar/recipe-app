class IngredientRecipe < ActiveRecord::Migration
  def up
  	...
  	execute "ALTER TABLE ingredients_recipes ADD CONSTRAINT fk_ingredients_recipes_recipe FOREIGN KEY (recipe_id) REFERENCES recipes(id)"
  	execute "ALTER TABLE ingredients_recipes ADD CONSTRAINT fk_ingredients_recipes_ingredient FOREIGN KEY (ingredient_id) REFERENCES ingredients(id)"
 	end 
