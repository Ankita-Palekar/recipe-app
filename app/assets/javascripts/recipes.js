(function(){
	$(document).ready(function(){ 
	  ...
	  var existing_ingredient_block = '<div class="control-group added-ingredient"><label class="control-label" for="ingredients">ingredient_name</label> <a class="close remove-added-ingredient" data-value="data_value">&times;</a> <div class="controls"> <input type="hidden" name="existing_ingredient[][ingredient_id]" value="ingredient_id_will_come_here">  <input type="hidden" name="existing_ingredient[][meal_class]" value="ingredient_meal_class"> <input type="hidden" name="existing_ingredient[][name]" value="ingredient_name"> <input type="hidden" name="existing_ingredient[][std_measurement]" value="ingredient_std_measurement"><input type="hidden" name="existing_ingredient[][std_quantity]" value="ingredient_std_quantity"> <input type="hidden" name="existing_ingredient[][calories_per_quantity]" value="ingredient_calories_per_quantity"> <div class="input-append"> <input placeholder="add-quantity" type="number" step="0.01" name="existing_ingredient[][quantity]" required><span class="add-on">ingredient_std_measurement</span> </div></div> </div>'
    	  ...
    	  // string = string.replace('ingredient_std_measurement', ing[5])
	    	...
	    	$(".chosen-select").chosen().change(function(e, params) {
	    		...
	    		if ('selected' in params) {
		    	  ...
		    	  $('#existing-ingredient-block').append(make_add_ingredient_html(ing))  
	    		};
	    	});
