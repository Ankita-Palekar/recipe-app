(function(){
	$(document).ready(function(){  
	  ...
	  var existing_ingredient_block = '<div class="control-group inline"> <div class="controls"> <label class="control-label" for="ingredients">ingredient_name</label> <input type="hidden" name="existing_ingredient[][ingredient_id]" value="ingredient_id_will_come_here">  <input type="hidden" name="existing_ingredient[][meal_class]" value="ingredient_meal_class"> <input type="hidden" name="existing_ingredient[][std_quantity]" value="ingredient_std_quantity"> <input type="hidden" name="existing_ingredient[][calories_per_quantity]" value="ingredient_calories_per_quantity"> <input placeholder="add-quantity" type="text" name="existing_ingredient[][quantity]" required> </div> </div>'
