module ReusableFunctionsTests
	...
	included do 
		@@ingredients_list = [{:id => 49 , :name => "casew1", :quantity => 0.0, :meal_class =>  "jain", :calories_per_quantity => 0.0 , :std_measurement => "g", :std_quantity => 0.0, :creator_id => 2},{:id=> 0, :name=>"sugar1", :meal_class=>"veg", :std_measurement=>"kg", :std_quantity=>1, :calories_per_quantity=>0, :quantity => 2, :creator_id => 2}, {:id => "", :name=>"tomato1", :meal_class=>"non-veg", :std_measurement=>"mg", :std_quantity=>0, :calories_per_quantity=>0, :quantity => 0, :creator_id => 2}]		
